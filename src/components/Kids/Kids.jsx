  ...
  return (
	...
	<section>
     ...
     <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
            ...
            <div key={prod.id} className="">
              <div className="sellcard">
                ...
                <div class="w-5/5 max-w-lg bg-white border border-gray-200 rounded-lg shadow-2xl palet  ">
                  <a href="#">
                    <img class="p-8 rounded-t-lg" src={`http://localhost:1337${prod.attributes.image.data[0].attributes.url}`} alt="product image" />
                  </a>
                  <div class="px-5 pb-5">
                    <a href="#">
        ...
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl  lg:text-6xl text-center py-14">Sports Shoes</h1>
     <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
        ...
        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl  lg:text-6xl text-center py-14">Shirts</h1>
     <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
