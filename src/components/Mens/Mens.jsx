  ...
  return (
    ...
    <section className="container">
      ...
      <div className="mainhero">
        ...
        <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center">
          {data.data.filter((prod) => prod.attributes.Subcategory === "tshirt").map(skeleton)}
        </div>
        ...
        <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center">
          {data.data.filter((prod) => prod.attributes.Subcategory === "pant").map(skeleton)}
        </div>
        ...
        <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center">
          {data.data.filter((prod) => prod.attributes.Subcategory === "caps").map(skeleton)}
        </div>
