...
const Women = () => {
  ...
  return (
    ...
    <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
        ...
        <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
          {data.data.filter((prod)=> (prod.attributes.subcategory === "tshirt" || prod.attributes.subcategory === "shirt")).map(prod => (
            <div key={prod.id} className="">
              <div className="sellcard">
        ...
        <div className=" mx-auto grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 justify-center container">
          {data.data.filter((prod)=> (prod.attributes.subcategory === "sandals")).map(prod => (
            <div key={prod.id} className="">
              <div className="sellcard">
